...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUIVIDONNEES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUIVIDONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUIVIDONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUIVIDONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUIVIDONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUIVIDONNEES actions', async () => {
      const expectedActions = [
        {
