...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './soignant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOIGNANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOIGNANT actions', async () => {
      const expectedActions = [
        {
