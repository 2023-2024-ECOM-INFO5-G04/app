...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICESOIGNANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVICESOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICESOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICESOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICESOIGNANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICESOIGNANT actions', async () => {
      const expectedActions = [
        {
