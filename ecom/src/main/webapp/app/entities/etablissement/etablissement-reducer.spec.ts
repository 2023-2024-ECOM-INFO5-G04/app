...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETABLISSEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETABLISSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETABLISSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETABLISSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETABLISSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETABLISSEMENT actions', async () => {
      const expectedActions = [
        {
