...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINISTRATEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADMINISTRATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINISTRATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINISTRATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINISTRATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINISTRATEUR actions', async () => {
      const expectedActions = [
        {
