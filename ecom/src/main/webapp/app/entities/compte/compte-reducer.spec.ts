...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './compte.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPTE actions', async () => {
      const expectedActions = [
        {
